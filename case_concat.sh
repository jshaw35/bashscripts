...
dst_a1,dst_a2,dst_a3,DST_A1,DST_A2,DST_A3,dst1_num,dst3_num,dst_c1_num,dst_c3_num,\
BCFREZIMM,BCFREZCNT,BCFREZDEP,FSNT,FSNTC,FLNT,FLNTC,FLDS,FSDS,FSNSC,FLNSC,FLDSC,FSDSC"
# echo $cospvars
